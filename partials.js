...
(function(){
  ...
  const li='M4.98 3.5A2.5 2.5 0 1 1 2.49 6 2.5 2.5 0 0 1 4.98 3.5ZM3 8.98h4v12.02H3V8.98Zm6 0h3.83v1.64h.05a4.2 4.2 0 0 1 3.78-2.08c4.04 0 4.79 2.66 4.79 6.12V21h-4v-5.33c0-1.27-.02-2.9-1.77-2.9-1.77 0-2.04 1.38-2.04 2.81V21H9V8.98Z';
  ...
  <footer class="footer">
    <div class="footer-top">
      ...
      <div class="footer-col">
        ...
        <div class="socials">
          ...
          <a href="https://www.linkedin.com/company/dunixabcreative" target="_blank" aria-label="LinkedIn"><svg viewBox="0 0 24 24" fill="currentColor"><path d="${li}"/></svg></a>
    ...
    <div class="footer-bottom">
      <span>© 2024–<span id="yr"></span> Dunixab Creative Studio. Est. October 2025.</span>
